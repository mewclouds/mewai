...
Today that's Claude Code, Codex, Hermes Agent, Antigravity CLI (`agy`), and Cursor. When I pick up another, I write one adapter in the renderer instead of maintaining another copy of my rules.
